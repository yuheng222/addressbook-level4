...
* 3a. There are multiple persons with the name entered.
+
[none]
** 3a1. AddressBook shows a list of phone numbers which belong to the matched persons.
+
Use case ends.
...
* 2a. The chosen file is in an unsupported format.
+
[none]
** 2a1. AddressBook shows an error message.
+
...
* 4a. A contact's details imported contains unrecognized characters.
+
[none]
** 4a1. AddressBook prompts user for either one of 2 actions: Do not import contact, or import contact but deletes the unrecognized characters.
** 4a2. User selects one of 2 options and AddressBook performs the corresponding action.
+
