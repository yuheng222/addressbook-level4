...
**Alternative 2:** Allow user to customise his own GUI colour scheme using a colour palette. +
...
**Pros:** Saves the hassle of implementing a new command, and the user can find out how each theme looks like by referring to the user guide since screenshots are provided. +
