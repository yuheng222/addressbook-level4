...
=== Enhancement Added: Auto-Backup of Address Book
...
In the case where any mistake was made and the app was closed (thus preventing the undo command from working on the next start), the previous backup can be retrieved.
