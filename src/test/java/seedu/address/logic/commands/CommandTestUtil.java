...
public class CommandTestUtil {
    ...
    public static final String INVALID_NOK_NAME_DESC = " " + PREFIX_NAME + "Jessie%"; // '%' not allowed in names
    public static final String INVALID_NOK_PHONE_DESC = " " + PREFIX_PHONE + "999m"; // 'm' not allowed in phones
