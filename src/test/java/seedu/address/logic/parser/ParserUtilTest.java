...
public class ParserUtilTest {
    ...
    private static final String INVALID_AVATAR = "src/main/resources/images/default";
    ...
    private static final String VALID_AVATAR = "";
    ...
    public void parseAvatar_invalidValue_throwsIllegalValueException() throws Exception {
        thrown.expect(IllegalValueException.class);
        ParserUtil.parseAvatar(INVALID_AVATAR);
    }
    ...
    public void parseAvatar_validValue_returnsAvatar() throws Exception {
        ...
        Avatar actualAvatar = ParserUtil.parseAvatar(VALID_AVATAR);
