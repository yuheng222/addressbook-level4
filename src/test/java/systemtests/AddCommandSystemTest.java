...
public class AddCommandSystemTest extends AddressBookSystemTest {
    ...
    public void add() throws Exception {
        ...
        toAdd = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY)
                .withAddress(VALID_ADDRESS_BOB).withAvatar(VALID_AVATAR_AMY).withNokName(VALID_NOK_NAME_AMY)
                .withNokPhone(VALID_NOK_PHONE_AMY).withTags(VALID_TAG_FRIEND).build();
        ...
        toAdd = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY)
                .withAddress(VALID_ADDRESS_AMY).withAvatar(VALID_AVATAR_AMY).withNokName(VALID_NOK_NAME_BOB)
                .withNokPhone(VALID_NOK_PHONE_AMY).withTags(VALID_TAG_FRIEND).build();
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + AVATAR_DESC_AMY + NOK_NAME_DESC_BOB + NOK_PHONE_DESC_AMY + TAG_DESC_FRIEND;
        assertCommandSuccess(command, toAdd);
        ...
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + AVATAR_DESC_AMY + NOK_NAME_DESC_AMY + NOK_PHONE_DESC_BOB + TAG_DESC_FRIEND;
        assertCommandSuccess(command, toAdd);
        ...
        command = AddCommand.COMMAND_WORD + TAG_DESC_FRIEND + NOK_NAME_DESC_BOB + PHONE_DESC_BOB + ADDRESS_DESC_BOB
                + AVATAR_DESC_BOB + NAME_DESC_BOB + TAG_DESC_HUSBAND + NOK_PHONE_DESC_BOB + EMAIL_DESC_BOB;
        assertCommandSuccess(command, toAdd);
        ...
        /* Case: missing NOK name -> rejected */
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + NOK_PHONE_DESC_AMY;
        assertCommandFailure(command, String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddCommand.MESSAGE_USAGE));

        /* Case: missing NOK phone -> rejected */
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + NOK_NAME_DESC_AMY;
        assertCommandFailure(command, String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddCommand.MESSAGE_USAGE));
        ...
        command = AddCommand.COMMAND_WORD + INVALID_NAME_DESC + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + AVATAR_DESC_AMY + NOK_NAME_DESC_AMY + NOK_PHONE_DESC_AMY;
