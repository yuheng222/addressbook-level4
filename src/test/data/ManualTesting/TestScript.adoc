...
image::{repoURL}/blob/master/docs/images/damithc.jpg[width="300"]

**Image 2**

image::{repoURL}/blob/master/docs/images/lejolly.jpg[width="300"]

**Image 3**

image::{repoURL}/blob/master/src/main/resources/images/default.png[width="300"]
